...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://173m0k6zwg.execute-api.us-west-2.amazonaws.com/dev';
    ...
    apigClient.searchGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['body', 'Content-Type', 'Accept', 'x-amz-meta-customLabels', 'Access-Control-Allow-Header', 'q'], ['body']);
        ...
        var searchGetRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Content-Type', 'Accept', 'x-amz-meta-customLabels', 'Access-Control-Allow-Header', ]),
    ...
    apigClient.searchOptions = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['Content-Type', 'Accept', 'x-amz-meta-customLabels', 'content-type'], ['body']);
        
        var searchOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/search').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Content-Type', 'Accept', 'x-amz-meta-customLabels', 'content-type']),
    ...
    apigClient.uploadBucketKeyGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['key', 'bucket'], ['body']);
        
        var uploadBucketKeyGetRequest = {
            verb: 'get'.toUpperCase(),
        ...
        return apiGatewayClient.makeRequest(uploadBucketKeyGetRequest, authType, additionalParams, config.apiKey);
    };
